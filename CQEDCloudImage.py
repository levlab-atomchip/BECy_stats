## TODO: get imagerotation in here!
...
class CloudImage():
    ...
    def loadMatFile(self):
        ...
        self.atomImage = np.flipud(scipy.array(self.imageArray[:,:,0]) )
        #scipy.array is called to make a copy, not a reference
        self.lightImage = np.flipud(scipy.array(self.imageArray[:,:,1]))
        self.darkImage = np.flipud(scipy.array(self.imageArray[:,:,2]))
        ...
        # self.truncWinX = [150, 1200]
        # self.truncWinY = [150, 900]
